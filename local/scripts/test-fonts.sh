...
function print-decimal-unicode-range() {
  ...
  # box.
  local bgColorBorder=$(tput setab 0)
  local bgColorCode=$(tput setab 0)
  local alternateBgColorCode=$(tput setab 0)
  local bgColorChar=$(tput setab 0)
  local alternateBgColorChar=$(tput setab 0)
